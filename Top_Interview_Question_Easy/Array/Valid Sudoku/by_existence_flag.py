        ...
        for i in range(9):
            for j in range(9):
                ...
                if board[i][j] != '.':
                    ...
                    # update row flag, column flag, 3x3 sub-block flagfor current number
...
#
# The overhead in space is the storage for flag table, 




from collections import namedtuple
TestEntry = namedtuple('TestEntry', 'board')
def test_bench():
    ...
    for t in test_data:
        ...
        print( Solution().isValidSudoku( board = t.board) )                
