        ...
        def helper_binary_search( nums, start, end, target):
            ...
            if nums[mid] < nums[end]:
                ...
                if nums[end] >= target > nums[mid]:
                    ...
                    return helper_binary_search( nums, mid+1, end, target)
                    
                else:
                    # search target in left half
                    return helper_binary_search( nums, start, mid-1, target)
...
#
# The overhead in space is the depth of call stack, which is of O( log n).
