...
# n = 3 , because input size in fixed to three indices

## Time Complexity: O( 1 )
#
# The overhead in time is the cost to sort 3 indices, which is of O( 3 log 3 ) = O( 1 ).

## Space Complexity: O( 1 )
#
# The overhead in space is the storage for output (min_moves, max_moves), which is of O( 1 ).
...
def test_bench():
    ...
    for indices in test_data:
        ...
        print( Solution().numMovesStones(*indices) )
