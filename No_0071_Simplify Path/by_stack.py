...
## Time Complexity
#
# The overhead in time is token parsing and stack operation, which is of O(n)

## Space Complexity
#
# The cost in space is storage for stack, which is of O( n )
...
class TestClass( unittest.TestCase ):
    ...
    def test_case_4(self):
        ...
        result = Solution().simplifyPath( path="/a/./b/../../c/" )
