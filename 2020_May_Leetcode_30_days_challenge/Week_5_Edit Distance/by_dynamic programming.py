...
# m : the character length of word_1
# n : the character length of word_2

## Time Complexity: O( m * n )
#
# The overhead in time is the cost of nested loop of 2D dynamic programming, which is of O( m * n )

## Space Complexity: O( m * n )
#
# The overhead in space is the storage for dynamic programming table, min_edit_dist, which is of O( m * n )


from collections import namedtuple
TestEntry = namedtuple('TestEntry', 'word_1 word_2')

def test_bench():

    test_data = [
                    TestEntry( word_1 = "horse", word_2 = "ros"),
                    TestEntry( word_1 = "intention", word_2 = "execution"),
                ]
