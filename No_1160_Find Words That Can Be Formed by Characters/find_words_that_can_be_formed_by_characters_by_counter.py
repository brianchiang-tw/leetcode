...
class Solution:
    def countCharacters(self, words: List[str], chars: str) -> int:
        ...
        # create a dictionary on chars
        # key : character
        # value: occurrence
        char_occ_dict = Counter( chars )        
        ...
        for word in words:
            ...
            char_pool = char_occ_dict.copy()
            for character in word:
                
                occurrence = char_pool.get( character, 0 )
                if occurrence != 0:
                    char_pool[ character ] = occurrence - 1
                else:
                    break
