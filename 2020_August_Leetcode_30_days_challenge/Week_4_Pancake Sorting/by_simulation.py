...
#
# The overhead in time is the cost of for-loop iteration with pancake-flip, which is of O( n^ 2)
...
# The solution in this challenge is not only and unique, therefore local test bench is not provided.